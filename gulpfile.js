...
function watchFiles() {
	watch(
		...
		series(devHTML, devStyles, previewReload, includeHTML)
	);
	watch(
...
function prodHTML() {
	return src(`${options.paths.dist.base}/**/*.html`).pipe(
...
exports.default = series(
	...
	parallel(devStyles, devScripts, devImages, devHTML, includeHTML), //Run All tasks in parallel
...
exports.prod = series(
	...
	parallel(prodStyles, prodScripts, prodImages, prodHTML, includeHTML), //Run All tasks in parallel
	includeHTML,
	buildFinish
);
